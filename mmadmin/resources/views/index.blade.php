...
<div class="container">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group input-group">
                        <input class="form-control" id="inpSearch" name="inpSearch" type="text" />
                    ...
                    <div class="form-group">
                        <select id="selRStatus" class="form-control">
                            ...
                            <option value="2">Unredeemed</option>
                        </select>
                    </div>
                    <div class="form-group">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="form-group input-group">
                <button type="button" class="btn btn-warning" onclick="window.open('/mmadmin/export');">Export to Excel</button>
            </div>
            <table class="table table-bordered alternate">
                ...
                <tbody>
                    ...
                    <tr class="info">
                        ...
                        <td><button type="button" class="btn btn-warning btn-circle" onclick="view({{ $user->id }}, '{{ url()->current() }}')"><i class="fa fa-eye"></i></button></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
